...
// 业务管理--DAPP应用
    ...
    },
    {
        ...
        component: asyncComponent(() => import('container/biz/store/shopOrder/shopOrder-addedit'))
    },
    {
        path: '/store/shopOrder-logistics',
        component: asyncComponent(() => import('container/biz/store/shopOrder/shopOrder-logistics'))
    }
];
