...
const ROUTES = [
    ...
    },
    {
        ...
        component: asyncComponent(() => import('container/biz/activity/bednReward/bednReward'))
    },
    {
        path: '/invitingFriends/bednReward/addedit',
        component: asyncComponent(() => import('container/biz/activity/bednReward/bednReward-addedit'))
    },
    // 邀请好友链接文本
    {
  ...
  // 闪兑管理
    ...
    },
   {
    ...
    // 星球必中用户
    {
        ...
        component: asyncComponent(() => import('container/biz/starLucky/starLuckyUser/starLuckyUser'))
    },
    {
        path: '/starLucky/starLuckyUser/addedit',
        component: asyncComponent(() => import('container/biz/starLucky/starLuckyUser/starLuckyUser-addedit'))
    },
    // 星球奖池
    {
        path: '/starLucky/starJackpot',
        component: asyncComponent(() => import('container/biz/starLucky/starJackpot/starJackpot'))
    },
    {
        path: '/starLucky/starJackpot/addedit',
        component: asyncComponent(() => import('container/biz/starLucky/starJackpot/starJackpot-addedit'))
    },
    {
    ...
    // 星球配置
    {
        ...
        component: asyncComponent(() => import('container/biz/starLucky/starConfiguration/starConfiguration'))
    },
    {
        path: '/starLucky/starConfiguration/addedit',
        component: asyncComponent(() => import('container/biz/starLucky/starConfiguration/starConfiguration-addedit'))
    },
    // 星球场次规则
    {
        path: '/starLucky/starRules',
        component: asyncComponent(() => import('container/biz/starLucky/starRules/starRules'))
    },
    {
        path: '/starLucky/starRules/addedit',
        component: asyncComponent(() => import('container/biz/starLucky/starRules/starRules-addedit'))
    },
    // 星球场次查询
    {
        path: '/starLucky/starQuery',
        component: asyncComponent(() => import('container/biz/starLucky/starQuery/starQuery'))
    },
    {
        path: '/starLucky/starQuery/addedit',
        component: asyncComponent(() => import('container/biz/starLucky/starQuery/starQuery-addedit'))
    },
    // 参与记录查询
    {
        path: '/starLucky/starParticipate',
        component: asyncComponent(() => import('container/biz/starLucky/starParticipate/starParticipate'))
    },
    {
        path: '/starLucky/starParticipate/addedit',
        component: asyncComponent(() => import('container/biz/starLucky/starParticipate/starParticipate-addedit'))
    },
    // 奖金收益查询
    {
        path: '/starLucky/starBonusIncome',
        component: asyncComponent(() => import('container/biz/starLucky/starBonusIncome/starBonusIncome'))
    },
    {
        path: '/starLucky/starBonusIncome/addedit',
        component: asyncComponent(() => import('container/biz/starLucky/starBonusIncome/starBonusIncome-addedit'))
    }
];
