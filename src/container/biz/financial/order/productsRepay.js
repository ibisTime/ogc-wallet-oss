...
import {
    ...
    cancelFetching,
    setSearchData
} from '@redux/biz/financial/productsRepay';
...
class ProductsRepay extends React.Component {
    render() {
        const fields = [{
            title: '名称（中文简体）',
            field: 'nameZhCn',
            ...
            btnEvent: {
                ...
                investFlowAll: (selectedRowKeys, selectedRows) => {
                    ...
                    if (!selectedRowKeys.length) {
                        ...
                        this.props.history.push(`/bizFinancial/productsRepay/investFlowAll?code=${selectedRowKeys[0]}&menu=repay'`);
                    }
                },
                repaymentPlan: (selectedRowKeys, selectedRows) => {
                    if (!selectedRowKeys.length) {
                        ...
                        this.props.history.push(`/bizFinancial/productsRepay/repaymentPlan?code=${selectedRowKeys[0]}&symbol=${selectedRows[0].symbol}`);
                    }
                }
            }
        });
